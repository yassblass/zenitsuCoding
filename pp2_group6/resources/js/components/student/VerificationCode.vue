<template>
  <div>
    ...
    >
      <b-form-input type="number" id="v_code-input" v-model="verificationData.v_code"  :formatter="formatNumber"></b-form-input>
    </b-form-group>
  ...
  export default {
    ...
    methods : {
        ...
        .then(function (response) {
          ...
          else if (response.data === à) {
              //Code verification 
              console.log('Verification code is already redeemed or student may not exist!');
